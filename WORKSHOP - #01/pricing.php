...
header('Location: pricing.php?status=pricing');
}
?>
			...
			<div class="col-lg-3">
				<div class="pricing-box-item">
					...
					<div class="pricing-container">
						<ul>
							<li><i class="icon-ok"></i> FULL COURSE</li>
							<li><i class="icon-ok"></i> HACKING NA PRATICA </li>
							<li><i class="icon-ok"></i> 15 Modulos Praticos</li>
							<li><i class="icon-ok"></i> +100 Labs</li>
							<li><i class="icon-ok"></i> Certificado Digital</li>
						</ul>
					</div>
					<div class="pricing-action">
						<a href="https://alegiaothehackersecurity-school.thinkific.com/courses/hacking-na-pratica-athsv01" class="btn btn-medium btn-theme"><i class="icon-bolt"></i> COMPRAR </a>
					</div>
				</div>
			</div>
			<div class="col-lg-3">
